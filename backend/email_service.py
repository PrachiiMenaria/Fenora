...
def send_email(to_address: str, subject: str, html_content: str, text_content: str = "") -> dict:
    ...
    if not api_key:
        return {
            "success": False,
            "error": "Email not configured. Set BREVO_API_KEY environment variable."
        }
    ...
    send_smtp_email = sib_api_v3_sdk.SendSmtpEmail(
        to=[{"email": to_address}],
        sender={"name": "Fenora", "email": os.getenv("EMAIL_SENDER", "cloudberryyohh@gmail.com")},
        subject=subject,
